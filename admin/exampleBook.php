                                ...
                                <header class="page-header">
                                    <nav>
                                        ...
                                        <ul class="admin-menu">
                                            ...
                                            <li>
                                                <a href="exampleBook.php?AdminID=$row[id];" class="edit" title="Edit"
                                                        data-toggle="tooltip">
                                                    <svg>
                                            ...
                                            <li>
                                                <a href="#0">
                                                    ...
                                                    <span>View books available</span>
                                                </a>
                                            </li>
                                            <li>
                                                  <!-- <a href="request_book.php?studentID=studentID=$row[studentID];;" class="edit" title="Edit"
                                                data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a> -->
                                                <a href="request_book.php?studentID=studentID=$row[studentID];">
                                                    <svg>
