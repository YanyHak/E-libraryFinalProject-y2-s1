...
<body>
    ...
    if (isset($_POST['save'])) {
        ...
        if (empty($_POST['studentName']) || empty($_POST['book_name'])) {
            ...
            // validate inputs
            // $today = date('Y-m-d');
            $issue_name = mysqli_real_escape_string($con, $_POST['studentName']);
            $issue_book = mysqli_real_escape_string($con, $_POST['book_name']);
            $issue_date = date('Y-m-d');
            $return_date = date('Y-m-d', strtotime("+" . $return_days . " days"));
            //insert query
            $sql = "INSERT INTO  book_issue(issue_name,issue_book,issue_date,return_date,issue_status) 
            VALUES ('$issue_name','$issue_book','$issue_date','$return_date','N')";
    ...
    <form action="./add-book-issue.php" method="POST">
        <div class="container">
            <div class="card">
                <div class="form">
                    <div class="left-side">
                        ...
                        <div class="steps-content">
                            ...
                            <p class="step-number-content active">Enter Book issue information.
                            </p>
                        </div>
                    </div>
                    <div class="right-side">
                        <div class="main active">
                            ...
                            <div class="text">
                                ...
                                <p>Enter Book issue information to database.</p>
                            </div>
                            ...
                            <div class="buttons">
                                <button class="next_button" type="submit" name="save">Add Issue</button>
                            </div>
                        </div>
