...
<head>
	...
	<link rel="stylesheet" href="asset/css/pro1.css">
...
<body>
    <!-- selection elements from database -->
    <?php
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()){ ?>
            ...
            <form action="AdminHead.php" method='POST' enctype="multipart/form-data">
                ...
                <header class="page-header">
                    <nav>
                        <a href="#0" aria-label="forecastr logo" class="logo">
                            ...
                            <img src="<?php echo $row["pro_img"]; ?>" alt="" class="profile-image img-circle" width='40px'
                                height='40px' style='border-radius:50%;'>
                            <span class="greeting" style="color:white;font-weight:bold;">
                        ...
                        <ul class="admin-menu">
                            ...
                            <li <?php if ($page == 'request_book') {
                                        echo 'active';
                                    } ?>>
                                
                                
                                <a href="request_book_stu.php">
                                    <svg>
                                        <use xlink:href="#settings"></use>
                                    </svg>
                                    <span>View Request Book</span>
                                </a>
                            </li>
                            <li <?php if ($page == 'email') {
                                        echo 'active';
                                    } ?>>
                                <a href="send_email_student.php">
                                    <svg>
                        ...
                        <div class="admin-profile">
                            <form>
                                ...
                                <button type="submit" aria-label="submit form">
                                    <!-- <svg aria-hidden="true">
            <use xlink:href="#search" style="font-size:20px;"></use>
          </svg> -->
                                </button>
                            </form>
                            <span class="greeting" style="color:#616161;font-weight:bold;">
                                <?php echo $row['username'] ?>
                            </span>
              ...
              <use xlink:href="#users"></use>
                                ...
                                <img src="<?php echo $row["pro_img"]; ?>" alt="" class="profile-image img-circle">
                            </div>
