...
<body>
    ...
    if (isset($_POST['Add'])) {
        ...
        if (mysqli_num_rows($result) > 0) { //check result rows
            ...
            //insert query
            $sql1 = "INSERT INTO book(book_name,book_category,book_author,book_publisher,book_status,books_image) VALUES ('{$book_name}','{$book_category}','{$book_author}','{$book_publisher}','Y',' $filepath ')";
                ...
                <div class="form">
                    <div class="left-side">
                        ...
                        <div class="steps-content">
                            ...
                            <p class="step-number-content active">Enter Author information.
                            </p>
                        </div>
                    </div>
                    <div class="right-side">
                        <div class="main active">
                            ...
                            <div class="text">
                                ...
                                <p>Enter Book information to database.</p>
                            </div>
                            ...
                            <div class="input-text">
                                <div class="input-div">
                                    <input type="text" name="book_name" required require id="user_name">
                                    <span>Book Name</span>
                                </div>
                                <div class="input-div">
                                    <select name="category">
                                        <option>Select book_category</option>
                                        <?php
                            ...
                            <div class="input-text">
                                <div class="input-div">
                                    <select name="author">
                                        <option>Select book_author</option>
                                        <?php
                                ...
                                <div class="input-div">
                                    ...
                                    <select name="publisher">
                                        <option>Select book_publisher</option>
                                        <?php
                            ...
                            <div class="buttons">
                                <button class="next_button" type="submit" name="Add">Add Book</button>
                            </div>
                        </div>
