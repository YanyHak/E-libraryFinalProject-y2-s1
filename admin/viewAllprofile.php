...
<body>
    <form action="./viewAllprofile.php" method="POST" enctype="multipart/form-data">
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<tr>
                                                    ...
                                                    <td>
                                                        <a href=\"request_book.php?studentID=$row[studentID];\" class=\"view\" title=\"View\" data-toggle=\"tooltip\"><i class=\"material-icons\">&#xE417;</i></a>
