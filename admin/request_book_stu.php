...
<body>
    <form action="./request_book_stu.php" method="POST">
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <button class="glow-button" type="button"><a href="add-book-issue.php">ADD Request</a>
                                </button>
                            </div>
                            <div class="col-sm-4">
                ...
                request_book.request_date,student.studentID,student.studentPhone,student.email,student.studentName,book.book_name FROM request_book
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr <?php echo $over; ?>>
                                        ...
                                        <td>
                                            <?php if ($row['request_status'] == 'Y') {
                                                echo "<span class='badge badge-success'>Receive</span>";
                                                //insert to issue book
                                                
                                            } else {
                                                echo "<span class='badge badge-danger'>Request</span>";
                                            } ?>
                                        </td>
                                        <td>
                                            <a href="#" class="view" title="View" data-toggle="tooltip"><i
                                                    class="material-icons">&#xE417;</i></a>
                                            <a href="receive_request.php?iid=<?php echo $row['request_id']; ?>" class="edit"
                                                title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                            <a href="delete_request_book.php?iid=<?php echo $row['request_id']; ?> "
                                                onClick="javascript: return confirm('Please confirm deletion');" class="delete"
                                ...
                                <tr>
                                    <td colspan="10">No Books Request</td>
                                </tr>
                            <?php } ?>
