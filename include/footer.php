    ...
    <div class="pg-footer">
        <footer class="footer">
            ...
            <div class="footer-content">
                <div class="footer-content-column">
                    <div class="footer-logo">
                        <a class="footer-logo-link" href="#">
                            ...
                            <h1><img src="asset/img/Biu logo.png" alt="" width="80px"; height="120px";></h1>
                        </a>
                    </div>
                    <div class="footer-menu">
                        <h2 class="footer-menu-name"> BELTEI INTERNATIONAL UNIVERSITY</h2>
                        <ul id="menu-get-started" class="footer-menu-list">
                            ...
                            <li class="menu-item menu-item-type-post_type menu-item-object-product">
                                <a href="#">Start with BIU-LIBRARY</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="footer-content-column">
                    <div class="footer-menu">
                        <h2 class="footer-menu-name"> Navigation Bar</h2>
