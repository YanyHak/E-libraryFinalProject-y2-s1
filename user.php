  ...
  <header class="page-header">
        <nav>
          <a href="#0" aria-label="forecastr logo" class="logo">
            ...
            <img src="<?php echo $row["pro_img"]; ?>" alt="" class="profile-image img-circle" width='40px' height='40px' style='border-radius:50%;'>
      <span class="greeting" style="color:white;font-weight:bold;"><?php echo $row['studentName'] ?></span>
          </a>
      ...
      <section class="page-content">
        <section class="search-and-user">
            ...
            <use xlink:href="#search" style="font-size:20px;"></use>
                ...
                <span class="greeting" style="color:#616161;font-weight:bold;"><?php echo $row['studentName'] ?></span>
    ...
    <section class="grid">
      <?php include('./admin/displayBook.php'); ?>
      <article></article>
      <article></article>
      <article></article>
      <article></article>
